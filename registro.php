                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                ...
                                <input type="number" min="0" id="pase_2dias" size="3" name="boletos[]" placeholder="0">
                            </div>
                        </div>
                        <!--tabla-precio-->
                ...
                <div class="caja clearfix">
                    <div class="extras">
                        <div class="orden">
                            ...
                            </br><input type="number" min="0" id="camisa_evento" size="3" name="pedido_camisas" placeholder="0">
                        </div>
